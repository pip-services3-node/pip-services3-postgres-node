# Development and Testing Guide <br/> Pip.Services PostgreSQL Components for Node.js
...
- Download and install PostgreSQL database from https://www.postgresql.org/download/
